    ...
    <div className={styles.main}>
      <div className={styles.popup}>
        ...
        <p className={styles.text}>
          ...
          français. <br />
          <br />
          Chaque jour, un mot de 5 lettres est choisi aléatoirement. Vous devez
          le deviner en 5 essais.
          <br />
          <br />À chaque essai, les lettres du mot que vous avez proposé
          changeront de couleur en fonction de à quel point vous êtes proche de
          le trouver.
        </p>
        ...
        <p className={styles.explain}>
          La lettre <span style={{ color: "#00BF63" }}>O</span> est dans le mot,
          à la bonne place.
        </p>
        <div className={styles.lines}>
        ...
        <p className={styles.explain}>
          La lettre <span style={{ color: "#545454" }}>T</span> n'est pas dans
          le mot.
        </p>
      </div>
    </div>
